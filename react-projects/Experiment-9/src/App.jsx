...
const student1 = new Student("Chimbili Sreekar", 20, "Computer Science");
console.log(student1.displayInfo());

const teacher1 = new Teacher("Dr. Vikranth", 45, "Artificial Intelligence");
console.log(teacher1.displayInfo());`;

  const student = new Student("Chimbili Sreekar", 20, "Computer Science");
  const teacher = new Teacher("Dr. Vikranth", 45, "Artificial Intelligence");
